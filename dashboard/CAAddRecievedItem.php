...
<body onload="printAndRedirect()">
    <div class="col-lg-12 stretch-card" id="billContent">
        <div class="card">
            <div class="card-body">
                <div style="border:5px solid; padding:5px;">
                    <div>
                    ...
                    <div class="table-responsive pt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="4" style="text-align:left;">
                                        <lable style="color:red;"> IMPORTANT </lable>- THE PRODUCT THAT YOU HAVE GIVEN
                                        TO OUR COMPANY WILL BE KEPT IN OUR COMPANY FOR A MAXIMUM WARRANTY PERIOD OF 01
                                        (ONE) MONTH , AND OUR COMPANY WILL NOT BEAR ANY RESPONSIBILITY FOR THE PRODUCT
                                        OFFER A PERIOD OF 02 (TWO) MONTH FROM THE DATE OF RECEIPT UNDER AGRACE PERIOD OF
                                        ONE MONTH
                                    </td>
                                </tr>
                                <tr>
                        ...
                        function printAndRedirect() {
                            ...
                            setTimeout(function() {
                                newWin.close();
                                window.location =
                                    'CARecieve.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&alert=3';
...
<?php
    ...
    header("Location:CARecieve.php?lid=$lid&home=$home&alert=5");
}
