                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title"
                                            ...
                                            Request to Cancel Bill</h4>
                                        <p class="card-description"> Please Fill All Fields</p>
                                        <form
                                            action="CARequesCancel.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&branchCode=<?php echo $branchCode; ?>"
                                            ...
                                            <button type="submit" id="addPurch" class="btn btn-primary me-2">Request to
                                                Cancel Bill</button>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT * FROM bill_head where BillingBranch='".$branchCode."' and cansel=1 ORDER BY billNo ASC";
