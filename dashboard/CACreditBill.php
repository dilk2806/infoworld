                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Credit Bill List</h4>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT bill_head.billNo,customer.name,customer.mobile FROM customer,bill_head where bill_head.cusBallence<0 and bill_head.cansel!=2 and bill_head.customerID=customer.id ORDER BY billNo ASC";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="CACreditBillPay.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&billNo=<?php echo $row["billNo"]; ?>">Pay
                                                                Bill</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
