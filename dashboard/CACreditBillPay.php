    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="CAIndex.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>">
                            <i class="fa fa-desktop menu-icon"></i>
                            <span class="menu-title">Billing</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="CACancelBill.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>">
                            <i class="fa fa-file-excel-o menu-icon"></i>
                            <span class="menu-title">Cancel Bill</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="CACreditBill.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>">
                            <i class="fa fa-credit-card menu-icon"></i>
                            <span class="menu-title">Credit Bill</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="CARecieve.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>">
                            <i class="fa fa-external-link menu-icon"></i>
                            <span class="menu-title">Recieve</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="CAProfile.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        ...
                                        $billTotal = $row_bill_data['billTotal'];
                                        $PaybleBillAmountSend = $row_bill_data['PaybleBillAmountSend'];
                                        $TotalDiscountSend = $row_bill_data['TotalDiscountSend'];
                                        $custPaid = $row_bill_data['custPaid'];
                                        $cusBallence = $row_bill_data['cusBallence'];
                                        $customerID = $row_bill_data['customerID'];

                                        $sel_cust_data = "SELECT * from customer where id='".$customerID."'";
                                        $run_cust_data = mysqli_query($con,$sel_cust_data);
                                        $row_cust_data = mysqli_fetch_assoc($run_cust_data);
                                        $cutName = $row_cust_data['name'];
                                        $cutMobile = $row_cust_data['mobile'];
                                        $cutAddress = $row_cust_data['address'];
                                    ?>
                                    <h4 class="card-title">Credit Bill No <?php echo $billNo; ?></h4>
                                    ...
                                    <table style="width:50%;">
                                        <tr>
                                            ...
                                            <th>: Rs. <?php echo $billTotal; ?></th>
                                        </tr>
                                        <tr>
                                            <th>Total Bill Discount</th>
                                            <th>: Rs. <?php echo $TotalDiscountSend; ?></th>
                                        </tr>
                                        <tr>
                                            <th>Payble Bill Price</th>
                                            <th>: Rs. <?php echo $PaybleBillAmountSend ?></th>
                                        </tr>
                                        <tr>
                                            <th>Customer Paid Amount</th>
                                            <th>: Rs. <?php echo $custPaid; ?></th>
                                        </tr>
                                        <tr>
                                            <th>Credit Amount</th>
                                            <th>: Rs. <?php echo $cusBallence; ?></th>
                                        </tr>
                                        <tr>
                                            <th colspan="">
                                                <hr>
                                        ...
                                        <tr>
                                            <th>Customer Name</th>
                                            <th>: <?php echo $cutName; ?></th>
                                        </tr>
                                        <tr>
                                            <th>Customer Mobile</th>
                                            <th>: <?php echo $cutMobile; ?></th>
                                        </tr>
                                        <tr>
                                            <th>Customer Address</th>
                                            <th>: <?php echo $cutAddress; ?></th>
                                        </tr>
                                    </table><br>

                                    <form
                                        action="CACreditBillPaid.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&billNo=<?php echo $billNo; ?>&branchCode=<?php echo $branchCode; ?>"
                                        method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 form-group">
                                                ...
                                                <input class="form-control btn btn-primary" id="submitBTN" type="submit"
                                                    value="Pay">
                                            </div>
                                        </div>
                                    </form>
