                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="filterForm" action="CARecieve.php" method="POST">
                                        <div class="row">
                                    ...
                                    document.getElementById('filterForm').addEventListener('submit', function(e) {
                                        ...
                                        var actionUrl = 'CARecieve.php?lid=' + encodeURIComponent(lid) +
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form
                                        action="CAAddRecievedItem.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>"
                                        ...
                                        <input type="text" name="rowData" style="display:none" id="rowData"
                                            required><br>
                                        <!--style="display:none" -->
                                        ...
                                        <button type="reset" class="btn btn-light"
                                            onclick="deleteTableBody()">Cancel</button>
                                        <script>
