...
if ($alert == 1 && $count == 0) {
    $message = "Bill Cancellation Success.";
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Cancel Bills List</h4>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="MACancelBillRequest.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&billNo=<?php echo $row["billNo"]; ?>">View
                                                                Bill</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
