            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <a href="MAApproveCancel.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&branchCode=<?php echo $branchCode; ?>&billNo=<?php echo $billNo; ?>"
                            class="btn btn-primary">Cancel Bill</a>
                    </div>
                </div>
