                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="text-center">
                            <a href="MACancelPurchaseItemsDB.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&PurchesNo=<?php echo $PurchesNo; ?>"
                                style="text-align:center; width:50%;" class="btn btn-primary">Cansel
                                Purchase</a>
                        </div>
