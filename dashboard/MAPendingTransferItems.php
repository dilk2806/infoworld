...
$ReceiveBranchCode = $_REQUEST['ReceiveBranchCode'];
...
$sel_TransferBranchCode = "select * from branches where branchCode='".$TransferBranchCode."'";
$run_TransferBranchCode = mysqli_query($con,$sel_TransferBranchCode);
$row_TransferBranchCode = mysqli_fetch_assoc($run_TransferBranchCode);
$TransferBranchName = $row_TransferBranchCode['branchName'];

$sel_ReceiveBranchCode = "select * from branches where branchCode='".$ReceiveBranchCode."'";
$run_ReceiveBranchCode = mysqli_query($con,$sel_ReceiveBranchCode);
$row_ReceiveBranchCode = mysqli_fetch_assoc($run_ReceiveBranchCode);
$ReceiveBranchName = $row_ReceiveBranchCode['branchName'];
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Pending Transfer Note Item List (To:
                                        <?php echo $ReceiveBranchName; ?>)</h4>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT transfer_data.itemCode,items.itemName,transfer_data.qty,transfer_data.checked FROM items,transfer_data WHERE transfer_data.TransferNo='".$TransferNo."' and transfer_data.TransferBranchCode='".$TransferBranchCode."' and transfer_data.ReceiveBranchCode='".$ReceiveBranchCode."' and items.itemCode=transfer_data.itemCode  and checked=0";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="#" class="btn btn-danger btn-sm">Not Checked</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
                                                </tbody>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable1">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT transfer_data.itemCode,items.itemName,transfer_data.qty,transfer_data.checked FROM items,transfer_data WHERE transfer_data.TransferNo='".$TransferNo."' and transfer_data.TransferBranchCode='".$TransferBranchCode."' and transfer_data.ReceiveBranchCode='".$ReceiveBranchCode."' and items.itemCode=transfer_data.itemCode  and checked=1";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["itemName"]; ?></td>
                                                        <td><?php echo $row["qty"]; ?></td>
                                                        <td><a href="#" class="btn btn-success btn-sm">Checked</a></td>
                                                    </tr>
                                                    <?php $count++; } ?>
                                                </tbody>
                                            </table>
