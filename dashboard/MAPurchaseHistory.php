                ...
                <div class="content-wrapper">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    document.getElementById('filterForm').addEventListener('submit', function(e) {
                                        ...
                                        var actionUrl = 'MAPurchaseHistory.php?lid=' + encodeURIComponent(lid) +
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Purchase<code><br>
                                    <?php
                                        if ($fromDate == $toDate){
                                            echo $fromDate; 
                                        } else {
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT * FROM purch_head WHERE DATE(timeSpan)>='".$fromDate."' AND DATE(timeSpan)<='".$toDate."' AND cansel=0";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                        $sel_supplier = "SELECT * from suplier where SuplierCode='".$row["SuplierCode"]."'";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["purchOfficer"]; ?></td>
                                                        <td><?php echo $row["InvoiceNo"]; ?></td>
                                                        <td><?php echo $row["purchTot"]; ?></td>
                                                        <td><?php echo $row_supplier["SuplierName"]; ?></td>
                                                        </td>
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="MAPurchaseHistoryItem.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&PurchesNo=<?php echo $row["PurchesNo"]; ?>">View
                                                                Purchase</a></td>
                                                    </tr>
                                                    <?php $count++; } ?>
                                                </tbody>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Serials of Suppliers<code>
                                    </code></h4>

                                    <div class="table-responsive pt-3">
                                        <input type="text" id="myInputSerial" onkeyup="myFunctionSerial()"
                                            placeholder="Search for names.." title="Type in a name">
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTableSerial">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Serial No.</th>
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT serial_no.serialNo,serial_no.PurchesNo,suplier.SuplierName 
                                                    FROM serial_no
                                                    JOIN purch_head
                                                        ON serial_no.PurchesNo = purch_head.PurchesNo
                                                    JOIN suplier
                                                        ON suplier.SuplierCode = purch_head.SuplierCode ";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                ?>
                                                    <tr>
                                        ...
                                        function myFunctionSerial() {
                                            ...
                                            filter = input.value.toUpperCase();
                                            table = document.getElementById("myTableSerial");
                                            tr = table.getElementsByTagName("tr");
                                            for (i = 0; i < tr.length; i++) {
                                                // Loop through all cells in the current row
                                                for (j = 0; j < tr[i].cells.length; j++) {
