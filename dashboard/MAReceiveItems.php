                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Receive Item List</h4>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT * FROM transfer_head where checked=0 and ReceiveBranchCode='".$branchCode."' ORDER BY timeSpan ASC";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                        $transferBranchCode = $row["TransferBranchCode"];

                                                        $sel_BName = "select * from branches where branchCode='".$transferBranchCode."'";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row_BName["branchName"]; ?></td>
                                                        <td><?php echo $row["TransferOfficer"]; ?></td>
                                                        <td><?php echo $row["TransferTot"]; ?></td>
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="MAReceiveItemsCheck.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&TransferNo=<?php echo $row["TransferNo"]; ?>&TransferBranchCode=<?php echo $row["TransferBranchCode"]; ?>&TransferOfficer=<?php echo $row["TransferOfficer"]; ?>&TransferTot=<?php echo $row["TransferTot"]; ?>">Check
                                                                Items</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
