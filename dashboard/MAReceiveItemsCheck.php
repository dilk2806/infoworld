...
$sel_TransferBranch = "select * from branches where branchCode='".$TransferBranchCode."'";
$run_TransferBranch = mysqli_query($con,$sel_TransferBranch);
$row_TransferBranch = mysqli_fetch_assoc($run_TransferBranch);
$TransferBranch = $row_TransferBranch['branchName'];
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Transfer Branch: <?php echo $TransferBranch; ?></h4>
                                    <h4 class="card-title">Transfer Officer: <?php echo $TransferOfficer; ?></h4>
                                    <h4 class="card-title">Total Price of Item(s): <?php echo $TransferTot; ?></h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Receive Item List (<?php echo $TransferBranch; ?>)</h4>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT * FROM transfer_data where checked=0 and ReceiveBranchCode='".$branchCode."' and TransferBranchCode='".$TransferBranchCode."' ORDER BY itemCode ASC";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                        $transferItemCode = $row["itemCode"];

                                                        $sel_BName = "select * from items where itemCode ='".$transferItemCode."'";
                                                        $run_BName = mysqli_query($con,$sel_BName);
                                                        $row_BName = mysqli_fetch_assoc($run_BName);
                                                        
                                                ?>
                                                    <tr>
                                                        <th scope="row"><?php echo $count; ?></th>
                                                        <td><?php echo $row["itemCode"]; ?></td>
                                                        <td><?php echo $row_BName["itemName"]; ?></td>
                                                        <td><?php echo $row["qty"]; ?></td>
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="MAReceiveItemsCheckApprove.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&TransferNo=<?php echo $row["TransferNo"]; ?>&TransferBranchCode=<?php echo $row["TransferBranchCode"]; ?>&itemCode=<?php echo $row["itemCode"]; ?>&receiveBranch=<?php echo $branchCode; ?>&TransferOfficer=<?php echo $TransferOfficer; ?>&TransferTot=<?php echo $TransferTot; ?>&qty=<?php echo $row["qty"]; ?>">Approve</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
                                                </tbody>
