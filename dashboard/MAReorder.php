                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    where items.itemCode=stock.itemCode and items.catCode=categories.catCode and items.brandCode=brand_names.brandCode and stock.branchCode='".$branchCode."' ORDER BY itemCode ASC";
