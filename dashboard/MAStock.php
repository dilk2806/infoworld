                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Branch Total Cost Price (Rs.)
                                    </h4>
                                    <?php
                                        $tot_comp_cost = 0;
                                        
                                        $sel_cost_tot = "SELECT stock.itemCode,stock.qty,items.costPrice FROM items,stock WHERE stock.itemCode=items.itemCode and stock.branchCode='".$branchCode."'";
                        ...
                        <div class="col-lg-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Branch Total Selling Price (Rs.)
                                    </h4>
                                    <?php
                                        $tot_comp_selling = 0;
                                        
                                        $sel_selling_tot = "SELECT stock.itemCode,stock.qty,items.sellingPrice FROM items,stock WHERE stock.itemCode=items.itemCode and stock.branchCode='".$branchCode."'";
                        ...
                        <div class="col-lg-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><?php echo $btanch; ?> Stock</h4>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;" id="StockReport">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT items.itemCode,items.itemName,stock.qty FROM items,stock where items.itemCode=stock.itemCode and stock.branchCode='".$branchCode."' ORDER BY itemCode ASC";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="MAStockItemDetails.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&itemCode=<?php echo $row["itemCode"]; ?>">More</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
                                                </tbody>
                                ...
                                <div class="text-center">
                                    ...
                                    function printAndRedirect() {
                                        ...
                                        newWin.document.write(
                                            '<html><head><style> table{width:100%;} @media print { th:last-child, td:last-child { display: none; } } </style></head><body onload="window.print();"><p><h1 style="text-align: center;"><?php echo $btanch ?><br>Stock Report By <?php echo date("Y-m-d  H:i"); ?></h1></p>' +
