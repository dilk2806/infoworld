                ...
                <div class="content-wrapper">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <?php
                                                $sel_perchase = "SELECT * from purch_head where branchCode='".$branchCode."' and PurchesNo='".$PurchesNo."' ";
                                                $run_perchase = mysqli_query($con, $sel_perchase);
                                                $row_perchase = mysqli_fetch_assoc($run_perchase);
                                                
                                                $suppler_code = $row_perchase['SuplierCode'];
                                                $sel_perchase1 = "SELECT * from suplier where SuplierCode ='".$suppler_code."' ";
                                                $run_perchase1 = mysqli_query($con, $sel_perchase1);
                                                $row_perchase1 = mysqli_fetch_assoc($run_perchase1);
                                            ?>
                                            <h5>Purchase No: <?php echo $PurchesNo; ?></h5>
                                            <h5>Purchase Officer: <?php echo $row_perchase['purchOfficer']; ?></h5>
                                            <h5>Total Purchase Amount: <?php echo $row_perchase['purchTot']; ?></h5>
                                        </div>
                                        <div class="col-lg-6 text-lg-right">
                                            <h5>Supplier:
                                                <?php echo $row_perchase1['SuplierName']; ?></h5>
                                            <h5>Invoice No:
                                                <?php echo $row_perchase['InvoiceNo']; ?></h5>
                                        </div>
                                    </div>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT purch_data.itemCode,items.itemName,purch_data.qty,purch_data.serialAdded FROM purch_data,items where purch_data.itemCode=items.itemCode and branchCode='".$branchCode."' and PurchesNo='".$PurchesNo."' ";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                        if ($row["qty"] == 0){
                                                            $serialAdded = "Not Added";
                                                        } else {
                                                            $serialAdded = "Added";
                                                        }
                                                ?>
                        ...
                        <div class="text-center">
                            <a href="POCanselPurchaseInvoiceDB.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&PurchesNo=<?php echo $PurchesNo; ?>"
                                style="text-align:center; width:50%;" class="btn btn-primary">Request To Cansel
                                Purchase</a>
                        </div>
