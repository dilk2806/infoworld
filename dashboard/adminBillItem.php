...
$branchCode = $_REQUEST['BillingBranch'];
...
$select_BillingBranch = "select * from branches where branchCode='".$branchCode."'";
$run_BillingBranch = mysqli_query($con,$select_BillingBranch);
$row_BillingBranch = mysqli_fetch_assoc($run_BillingBranch);

$BillingBranchName = $row_BillingBranch['branchName'];
