...
$lid = $_REQUEST['lid'];
$home = $_REQUEST['home'];
$BrachStockCode = $_REQUEST['BrachStockCode'];
...
$sel_branch = "select * from branches where branchCode='".$BrachStockCode."'";
$run_branch = mysqli_query($con,$sel_branch);
$row_branch = mysqli_fetch_assoc($run_branch);
$btanchNamae = $row_branch['branchName'];
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-4 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><?php echo $btanchNamae; ?> Branch Total Cost Price (Rs.)
                                    </h4>
                                    <?php
                                        $tot_comp_cost = 0;
                                        
                                        $sel_cost_tot = "SELECT stock.itemCode,stock.qty,items.costPrice FROM items,stock WHERE stock.itemCode=items.itemCode and stock.branchCode='".$BrachStockCode."'";
                        ...
                        <div class="col-lg-4 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><?php echo $btanchNamae; ?> Branch Total Selling Price (Rs.)
                                    </h4>
                                    <?php
                                        $tot_comp_selling = 0;
                                        
                                        $sel_selling_tot = "SELECT stock.itemCode,stock.qty,items.sellingPrice FROM items,stock WHERE stock.itemCode=items.itemCode and stock.branchCode='".$BrachStockCode."'";
                        ...
                        <div class="col-lg-4 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><?php echo $btanchNamae; ?> Branch Total Profite (Rs.)</h4>
                                    <?php
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><?php echo $btanchNamae; ?> Branch Stock</h4>
                                    <!-- <p class="card-description"><code></code> -->
                                    </p>
                                    <input type="text" id="myInput" onkeyup="myFunction()"
                                        placeholder="Search for names.." title="Type in a name">
                                    <div class="table-responsive pt-3" id="StockReport">
                                        <table class="table table-hover" id="myTable">
                                            ...
                                            <tbody>
                                                <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT items.itemCode,items.itemName,stock.qty FROM items,stock where items.itemCode=stock.itemCode and stock.branchCode='".$BrachStockCode."' ORDER BY itemCode ASC";
                                ...
                                <div class="text-center">
                                    ...
                                    function printAndRedirect() {
                                        ...
                                        newWin.document.write(
                                            '<html><head><style> table{width:100%;} @media print { th:last-child, td:last-child { display: none; } } </style></head><body onload="window.print();"><p><h1 style="text-align: center;"><?php echo $btanchNamae; ?> Branch<br>Stock Report By <?php echo date("Y-m-d  H:i"); ?></h1></p>' +
