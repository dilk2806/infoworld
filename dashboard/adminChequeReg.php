...
if ($alert == 1 && $count == 0) {
    $message = "Successfully Realized Cheque.";
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Today Realized Cheque List</h4>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT payment_method.id,payment_method.BrachCode,branches.branchName,payment_method.perchusNo,payment_method.chequeDate,payment_method.paidAmount,payment_method.chequeNo,payment_method.chequeDate,payment_method.BankName FROM payment_method,branches
                                                    where payment_method.BrachCode=branches.branchCode and payment_method.paymentMethod='cq' and payment_method.chequeDate<='".$today."' and payment_method.Reserve=0 ORDER BY payment_method.chequeDate DESC";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                ?>
                                                    <tr>
                                                        <th scope="row"><?php echo $count; ?></th>
                                                        <td><?php echo $row["BrachCode"]; ?></td>
                                                        <td><?php echo $row["branchName"]; ?></td>
                                                        <td><?php echo $row["perchusNo"]; ?></td>
                                                        <td><?php echo $row["chequeNo"]; ?></td>
                                                        <td><?php echo $row["paidAmount"]; ?></td>
                                                        <td><?php echo $row["chequeDate"]; ?></td>
                                                        <td><?php echo strtoupper($row["BankName"]); ?></td>
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="adminChequeRealized.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&chequeId=<?php echo $row["id"]; ?>">Realized</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
                                                </tbody>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">To Realized Cheque List</h4>
                                    <?php $today = date("Y-m-d"); ?>
                                    <!-- <p class="card-description"><code></code> -->
                                    </p>
                                    <div class="table-responsive pt-3">
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    $count = 1;
                                                    $sel_query12 = "SELECT payment_method.id,payment_method.BrachCode,branches.branchName,payment_method.perchusNo,payment_method.chequeDate,payment_method.paidAmount,payment_method.chequeNo,payment_method.chequeDate,payment_method.BankName FROM payment_method,branches
                                                    where payment_method.BrachCode=branches.branchCode and payment_method.paymentMethod='cq' and payment_method.chequeDate>'".$today."' and payment_method.Reserve=0 ORDER BY payment_method.chequeDate ASC";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                ?>
                                                    <tr>
