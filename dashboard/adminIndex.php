        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="adminPendingTransfer.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>">
                            ...
                            <div class="col-md-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="regItem.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    ...
                                                    <input type="text" name="CatagoryName" class="form-control"
                                                        id="CatagoryName" placeholder="Catagory name" required readonly
                                                        style="color:black; background-color: #EBEDEF;">
                                                </div>
                                                <script>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 form-group">
                                                    ...
                                                    <?php
                                                        $sel_icode = "select icode from icode";
                                                        $run_icode = mysqli_query($con,$sel_icode);
                                                        $row_icode = mysqli_fetch_assoc($run_icode);
                                                        $icode = $row_icode['icode']+1;
                                                    ?>
                                                    <input type="text" name="ItemCode" class="form-control"
                                                        id="ItemCode" placeholder="Item code" value="<?php echo $icode; ?>" required
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 form-group" style="display:none;">
                                                    ...
                                                    <input type="text" name="CostPrice" class="form-control"
                                                        id="CostPrice" placeholder="Cost price" required value="0"
                                                ...
                                                <div class="col-md-4 form-group" style="display:none;">
                                                    ...
                                                    <input type="text" name="SellingPrice" class="form-control"
                                                        id="SellingPrice" placeholder="Selling price" required value="0"
                                                        style="color:black; background-color: #D1F2EB;">
                                                </div>
                                            </div>
                                            <button type="submit" id="itemRegBTN" class="btn btn-primary me-2">Register</button>
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        $('#BrandCode').keydown(function(event) {
                                            if (event.keyCode == 13) {
                                                event.preventDefault();
                                                // $('#addPurch').click();
                                                $('#ItemCode').focus();
                                        ...
                                        $('#ReorderLevel').keydown(function(event) {
                                            if (event.keyCode == 13) {
                                                event.preventDefault();
                                                $('#itemRegBTN').click();
                                                // $('#chequeDate').focus();
                                ...
                                <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title"
                                                style="color:white; background-color: darkblue; padding:5px; border-radius:5px;">
                                                Catgory Registation</h4>
                                            <p class="card-description"> Please Fill All Fields</p>
                                            <form
                                                action="regCatagory.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>"
                                                method="POST" class="forms-sample">
                                                <div class="form-group">
                                                    <label for="CatagoryCode">Category code</label>
                                                    <input type="text" name="CatagoryCode" class="form-control"
                                                        id="CatagoryCode" placeholder="Category code" required>
                                                    <div id="catCodeDropdown"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="CatagoryName">Catagory name</label>
                                                    <input type="text" name="CatagoryName" class="form-control"
                                                        id="CatagoryName" placeholder="Catagory name" required>
                                                </div>
                                ...
                                <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title"
                                                style="color:white; background-color: darkblue; padding:5px; border-radius:5px;">
                                                Brand Registation</h4>
                                            <p class="card-description"> Please Fill All Fields</p>
                                            <form id="brandReg"
                                                action="regBrand.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>"
                                                method="POST" class="forms-sample">
                                                <div class="form-group">
                                                    <label for="CatagoryCode">Category code</label>
                                                    <select name="CatagoryCode" id="CatagoryCode"
                                                        ...
                                                        <?php
                                                            ...
                                                            $run_catCode = mysqli_query($con,$select_catCode);
                                                            while($row = mysqli_fetch_assoc($run_catCode)){ ?>
                                                        <option value="<?php echo $row['catCode'] ?>">
                                                            <?php echo $row['catCode'] ?> -
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="BrandCode" class="form-control"
                                                        id="BrandCode" placeholder="Brand code" required>
                                                    <div id="catCodeDropdown"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="BrandName">Brand name</label>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT * FROM items ORDER BY itemCode ASC";
