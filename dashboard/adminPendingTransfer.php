                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Transfer Branch Code</th>
                                                        <th>Transfer Branch Name</th>
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT transfer_head.TransferNo,transfer_head.TransferBranchCode,transfer_head.ReceiveBranchCode,branches.branchName,transfer_head.TransferTot,transfer_head.timeSpan FROM transfer_head,branches WHERE  transfer_head.TransferBranchCode=branches.branchCode  and checked=0";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                        $ReceiveBranchCode = $row['ReceiveBranchCode'];

                                                        $sel_query121 = "SELECT branchName FROM branches WHERE branchCode='".$ReceiveBranchCode."' ";
                                                        $result121 = mysqli_query($con, $sel_query121);
                                                        $row1 = mysqli_fetch_assoc($result121);
                                                        $ReceiveBranchName = $row1['branchName'];
                                                ?>
                                                    <tr>
                                                        <th scope="row"><?php echo $count; ?></th>
                                                        <td><?php echo $row["TransferBranchCode"]; ?></td>
                                                        <td><?php echo $row["branchName"]; ?></td>
                                                        <td><?php echo $row["ReceiveBranchCode"]; ?></td>
                                                        <td><?php echo $ReceiveBranchName; ?></td>
                                                        <td><?php echo $row["TransferTot"]; ?></td>
                                                        <td><?php echo date('Y-m-d', strtotime($row["timeSpan"])); ?>
                                                        </td>
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="adminPendingTransferItems.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&TransferNo=<?php echo $row["TransferNo"]; ?>&TransferBranchCode=<?php echo $row["TransferBranchCode"]; ?>&ReceiveBranchCode=<?php echo $ReceiveBranchCode; ?>">Transfer
                                                                Items</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
