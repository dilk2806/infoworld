                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Pending Transfer Note Item List (From:
                                        <?php echo $TransferBranchName; ?> To: <?php echo $ReceiveBranchName; ?>)</h4>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT transfer_data.itemCode,items.itemName,transfer_data.qty,transfer_data.checked FROM items,transfer_data WHERE  items.itemCode=transfer_data.itemCode  and checked=0";
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable1">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT transfer_data.itemCode,items.itemName,transfer_data.qty,transfer_data.checked FROM items,transfer_data WHERE  items.itemCode=transfer_data.itemCode  and checked=1";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                ?>
                                                    <tr>
