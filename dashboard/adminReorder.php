                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Re-Ordering Branch List</h4>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT stock.qty,items.reorderLevel,branches.branchCode,branches.branchName,branches.BranchTel FROM items,branches,stock
                                                    where items.itemCode=stock.itemCode and stock.branchCode=branches.branchCode GROUP BY branches.branchCode ORDER BY branches.branchCode ASC";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["BranchTel"]; ?></td>
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="adminBranchReorderItem.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&branchCode=<?php echo $row["branchCode"]; ?>">View
                                                                Re-order Item(s)</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; }} ?>
