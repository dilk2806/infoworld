                ...
                <div class="content-wrapper">
                    <div class="row">
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_branches = "SELECT * FROM branches ORDER BY branchCode ASC";
                                                    $result_branches = mysqli_query($con, $sel_branches);
                                                    while ($row_branches = mysqli_fetch_assoc($result_branches)) {
                                                ?>
                                                    <tr>
                                                        <th scope="row"><?php echo $count; ?></th>
                                                        <td><?php echo $row_branches["branchCode"]; ?></td>
                                                        <td><?php echo $row_branches["branchName"]; ?></td>
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="adminBranchStockDetails.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&BrachStockCode=<?php echo $row_branches["branchCode"]; ?>">View
                                                                Branch Stock</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
                        ...
                        <div class="col-lg-4 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Company Total Cost Price (Rs.)</h4>
                                    <?php
                                        $tot_comp_cost = 0;
                                        
                                        $sel_cost_tot = "SELECT stock.itemCode,stock.qty,items.costPrice FROM items,stock WHERE stock.itemCode=items.itemCode";
                                        $run_cost_tot = mysqli_query($con, $sel_cost_tot);

                                        while($row_cost_tot = mysqli_fetch_assoc($run_cost_tot)){
                                            
                                            $item_cost_tot = $row_cost_tot['costPrice'] * $row_cost_tot['qty'];

                                            $tot_comp_cost += $item_cost_tot;
                                        }
                                    ?>
                                    <h2 class="text-center"><?php echo number_format($tot_comp_cost, 2, '.', ','); ?>
                                    </h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Company Total Selling Price (Rs.)</h4>
                                    <?php
                                        $tot_comp_selling = 0;
                                        
                                        $sel_selling_tot = "SELECT stock.itemCode,stock.qty,items.sellingPrice FROM items,stock WHERE stock.itemCode=items.itemCode";
                                        $run_sellingt_tot = mysqli_query($con, $sel_selling_tot);

                                        while($row_selling_tot = mysqli_fetch_assoc($run_sellingt_tot)){
                                            
                                            $item_selling_tot = $row_selling_tot['sellingPrice'] * $row_selling_tot['qty'];

                                            $tot_comp_selling += $item_selling_tot;
                                        }
                                    ?>
                                    <h2 class="text-center"><?php echo number_format($tot_comp_selling, 2, '.', ','); ?>
                                    </h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Company Total Profite (Rs.)</h4>
                                    <?php
                                        $tot_comp_profite = $tot_comp_selling - $tot_comp_cost;
                                        
                                    ?>
                                    <h2 class="text-center"><?php echo number_format($tot_comp_profite, 2, '.', ','); ?>
                                    </h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Company Stock</h4>
                                    <!-- <p class="card-description"><code></code> -->
                                    </p>
                                    <div class="table-responsive pt-3">
                                        <input type="text" id="myInput" onkeyup="myFunction()"
                                            placeholder="Search for names.." title="Type in a name">
                                        <div style="overflow-y: auto; max-height: 500px;" id="StockReport">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT items.itemCode,items.itemName,SUM(stock.qty) as stockQTY FROM items,stock where items.itemCode=stock.itemCode GROUP BY stock.itemCode ORDER BY itemCode ASC";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-primary btn-sm"
                                                                href="adminItemDetails.php?lid=<?php echo $lid; ?>&home=<?php echo $home; ?>&itemCode=<?php echo $row["itemCode"]; ?>">More</a>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
                                                </tbody>
                                ...
                                <div class="text-center">
                                    ...
                                    function printAndRedirect() {
                                        ...
                                        var divToPrint = document.getElementById('StockReport');

                                        var newWin = window.open('', 'Print-Window');
                                        newWin.document.open();
                                        newWin.document.write(
                                            '<html><head><style> table{width:100%;} @media print { th:last-child, td:last-child { display: none; } } </style></head><body onload="window.print();"><p><h1 style="text-align: center;">Total Company<br>Stock Report By <?php echo date("Y-m-d  H:i"); ?></h1></p>' +
