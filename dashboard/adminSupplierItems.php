                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        $sel_supplier = " SELECT * from suplier where SuplierCode='".$supplier."'";
                                        $run_supplier = mysqli_query($con, $sel_supplier);
                                        $row_supplier = mysqli_fetch_assoc($run_supplier);
                                    ?>
                                    <h4 class="card-title">Items of <?php echo $row_supplier['SuplierName']; ?></h4>
                                        ...
                                        <div style="overflow-y: auto; max-height: 500px;">
                                            <table class="table table-hover" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $sel_query12 = "SELECT * FROM supplier_item where supplier_code='".$supplier."' ORDER BY item_code ASC";
                                                    $result12 = mysqli_query($con, $sel_query12);
                                                    while ($row = mysqli_fetch_assoc($result12)) {
                                                        $sel_itemName = "SELECT itemName from items where itemCode='".$row['item_code']."'";
